 ...
 */
final class Version20250622155456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE "order" (id INT NOT NULL, owner_id INT NOT NULL, amount DOUBLE PRECISION NOT NULL, date_open TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_close TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, state INT NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_F52993987E3C61F9 ON "order" (owner_id)
        SQL);
        $this->addSql(<<<'SQL'
            COMMENT ON COLUMN "order".date_open IS '(DC2Type:datetime_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
            COMMENT ON COLUMN "order".date_close IS '(DC2Type:datetime_immutable)'
        SQL);
        $this->addSql(<<<'SQL'
